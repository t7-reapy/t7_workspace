...
function wait_for_inspect()
{
	...
	for(;;)
	{
		if(self UseButtonPressed())
		{
			...
			if( self UseButtonPressed() && can_inspect && !self isReloading() && !self isSwitchingWeapons() && !self IsUsingOffHand() && !self isThrowingGrenade() ) //make sure you're not reloading, using offhands OR throwing grenades
			{

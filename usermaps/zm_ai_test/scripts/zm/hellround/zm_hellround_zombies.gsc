...
function init() 
{
    ...
    clientfield::register("actor", HELLROUND_ZOMBIE_MODEL_CF_NAME, VERSION_DLC4, 1, "int");
}
...
{
    self clientfield::set(HELLROUND_ZOMBIE_MODEL_CF_NAME, 0);
...
{
    self clientfield::set(HELLROUND_ZOMBIE_MODEL_CF_NAME, 1);

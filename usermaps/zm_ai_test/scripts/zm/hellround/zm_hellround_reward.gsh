...
#define HRRWRD_FINISHED_MAP_AND_SURVIVED_BAD_PATH_WEAPON "iw8_357"
#define HRRWRD_FINISHED_MAP_AND_SURVIVED_BAD_PATH_WEAPON_CAMO_INDEX 0
...
#define HRRWRD_DATA_HAS_SURVIVED_BAD_PATH_SHIFT 5

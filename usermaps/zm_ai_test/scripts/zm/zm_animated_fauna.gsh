...
#define MAX_RATS_RUNNING 8
#define MIN_DELAY_BETWEEN_RATS_ANIMATIONS 1.0
#define MAX_DELAY_BETWEEN_RATS_ANIMATIONS 5.0
#define MIN_DELAY_BETWEEN_RATS_ANIMATION_LOOP 5.00
#define MAX_DELAY_BETWEEN_RATS_ANIMATION_LOOP 10.0
...
#define MAX_RAVENS_FLYING 10
#define MIN_DELAY_BETWEEN_RAVENS_ANIMATIONS 1.0
#define MAX_DELAY_BETWEEN_RAVENS_ANIMATIONS 5.0
#define MIN_DELAY_BETWEEN_RAVENS_ANIMATION_LOOP 5.00
#define MAX_DELAY_BETWEEN_RAVENS_ANIMATION_LOOP 10.0

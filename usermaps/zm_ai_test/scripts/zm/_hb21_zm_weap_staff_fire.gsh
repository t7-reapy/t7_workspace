...
#define FIRESTAFF_WEAPON "t9_1911_rdw_up_up"
...
#define FIRESTAFF_BURN_STATE 0 // 0 == 1 == red, 1 == green, 2 == purple (check gdt mc/mtl_burnover)
#define FIRESTAFF_BURN_BRIGHTNESS 0.2

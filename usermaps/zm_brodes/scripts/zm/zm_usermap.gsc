...
function zm_brodes_test_zone_init()
{
...
function lightstates()
{
	...
	{
        WAIT_SERVER_FRAME;
        dvar_zm_brodes = ToLower(GetDvarString("lightstate", ""));

        if(isdefined(dvar_zm_brodes) && dvar_zm_brodes != "")
        {
            ModVar("lightstate", "");

            level util::set_lighting_state(Int(dvar_zm_brodes));
            IPrintLn("lighting state " + dvar_zm_brodes);        
        }
    }
}
...
function private change_round()
{
	...
	{
        WAIT_SERVER_FRAME;
        dvar_zm_brodes = ToLower(GetDvarString("round", ""));

        if(isdefined(dvar_zm_brodes) && dvar_zm_brodes != "")
        {
            ModVar("round", "");

            round = Int(dvar_zm_brodes);
...
function private change_weapon_camo()
{
	...
	{
        WAIT_SERVER_FRAME;
        dvar_zm_brodes = ToLower(GetDvarString("camo", ""));

        if(isdefined(dvar_zm_brodes) && dvar_zm_brodes != "")
        {
            ModVar("camo", "");

            string_token = StrTok(dvar_zm_brodes, " ");
...
function change_characterindex()
{
    ...
    for(;;)
	{
        dvar_zm_brodes = ToLower( GetDvarString( "character", "" ) );
        if( isdefined( dvar_zm_brodes ) && dvar_zm_brodes != "" )
		{
            string_token = StrTok( dvar_zm_brodes, " " );
            if( string_token.size > 1 ) 
...
function upgrade_weapon()
{
    ...
    for(;;)
	{
        ...
        WAIT_SERVER_FRAME;
        dvar_zm_brodes = ToLower(GetDvarString("upgrade_weapon", "none"));

        if(isdefined(dvar_zm_brodes) && dvar_zm_brodes != "none")
        {
            ModVar("upgrade_weapon", "none");
...
function private downgrade_weapon()
{
    ...
    for(;;)
	{
        ...
        WAIT_SERVER_FRAME;
        dvar_zm_brodes = ToLower(GetDvarString("downgrade_weapon", ""));
...
function give_points()
{
	...
	{
        WAIT_SERVER_FRAME;
        dvar_zm_brodes = ToLower(GetDvarString("points", ""));
...
function private give_weapon()
{
	...
	{
        WAIT_SERVER_FRAME;
        dvar_zm_brodes = ToLower(GetDvarString("give", ""));
...
function private give_perks()
{
	...
	{
        WAIT_SERVER_FRAME;
        dvar_zm_brodes = ToLower(GetDvarString("perk", ""));
...
function give_powerups()
{
    ...
    for(;;)
	{
        ...
        dvar_zm_brodes = ToLower(GetDvarString("powerup", ""));

...
function update_actor_fxs(n_client_num, _oldVal, should_be_playing_fx, _bNewEnt, _bInitialSnap, _fieldName, _bWasTimeJump)
{
    ...
    {
        level._effect["zombie_guts_explosion"] = HRZM_ZOMBIE_BLOODBATH_DEFAULT_FX;

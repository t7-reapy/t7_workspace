...
function viewmodel_update_loop(localClientNum)
{
    ...
    while (true)
    {
        ...
        // Detect swimming (proper engine function)
        ...
        // Smooth transition
        self.vm_bob_grounded = lerp(self.vm_bob_grounded, grounded, 0.1);

        // MOVEMENT GUN BOB
        moveSpeed = sqrt(fwdSpeed * fwdSpeed + rightSpeed * rightSpeed);

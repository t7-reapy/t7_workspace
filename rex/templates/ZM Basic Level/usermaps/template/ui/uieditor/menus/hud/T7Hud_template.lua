...
require( "ui.uieditor.widgets.HUD.ZM_PowerupsWidget.ZMPowerupsContainer" )
...
LUI.createMenu.T7Hud_zm_factory = function ( controller )
	...
	self.ZMPowerupsContainer = CoD.ZMPowerupsContainer.new( self, controller )
	self.ZMPowerupsContainer:setLeftRight( true, true, 0, 0 )
	self.ZMPowerupsContainer:setTopBottom( true, true, 0, 0 )
	self:addElement( self.ZMPowerupsContainer )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		element.ZMPowerupsContainer:close()

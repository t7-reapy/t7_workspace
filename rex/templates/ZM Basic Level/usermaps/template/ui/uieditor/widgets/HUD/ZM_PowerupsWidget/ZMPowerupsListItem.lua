CoD.ZMPowerupsListItem = InheritFrom( LUI.UIElement )
CoD.ZMPowerupsListItem.new = function ( menu, controller )
	...
	self:setClass( CoD.ZMPowerupsListItem )
	self.id = "ZMPowerupsListItem"
	self.soundSet = "HUD"

...
#precache( "client_fx", "dlc4/genesis/fx_margwa_roar_fire" );
#precache( "client_fx", "dlc4/genesis/fx_margwa_spawn_fire" );
#precache( "client_fx", "dlc4/genesis/fx_margwa_attack_fire" );
#precache( "client_fx", "zombie/fx_meatball_portal_sky_zod_zmb" );
#precache( "client_fx", "dlc4/genesis/fx_margwa_head_shot_fire" );
#precache( "client_fx", "dlc4/genesis/fx_margwa_roar_shadow" );
#precache( "client_fx", "dlc4/genesis/fx_margwa_spawn_shadow" );
#precache( "client_fx", "dlc4/genesis/fx_margwa_portal_open_shadow" );
#precache( "client_fx", "dlc4/genesis/fx_margwa_portal_loop_shadow" );
#precache( "client_fx", "dlc4/genesis/fx_margwa_portal_close_shadow" );
#precache( "client_fx", "dlc1/castle/fx_demon_gate_portal_open" );
#precache( "client_fx", "smoke/fx_smk_barrel_30x30" );
#precache( "client_fx", "dlc4/genesis/fx_margwa_head_shot_shadow" );
#precache( "client_fx", "dlc4/genesis/fx_margwa_roar_light" );
#precache( "client_fx", "dlc4/genesis/fx_margwa_spawn" );
#precache( "client_fx", "dlc4/genesis/fx_margwa_roar_electricity" );
...
function autoexec init()
{
	...
	level._effect[ "margwa_shadow_head_hit" ] = "dlc4/genesis/fx_margwa_attack_fire";

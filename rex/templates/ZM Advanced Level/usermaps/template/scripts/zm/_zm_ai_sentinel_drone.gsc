...
function function_caadf4b1()
{
	...
	{
		function_adf4d1d0(var_7f0cc3c7);
	}
}
...
function sentinel_drone_spawn(n_to_spawn = 1, var_e41e673a, b_force_spawn = 0, var_b7959229 = undefined)
{
	n_spawned = 0;
...
function sentinel_drone_special_spawn()
{
	...
	sentinel_drone_spawn(1, undefined, 1, s_spot);
	return true;
}
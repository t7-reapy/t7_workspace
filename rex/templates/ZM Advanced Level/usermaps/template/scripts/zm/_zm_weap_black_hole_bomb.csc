...
#precache( "client_fx", "dlc5/cosmo/fx_zmb_blackhole_looping");
#precache( "client_fx", "dlc5/cosmo/fx_zmb_blackhole_implode");
#precache( "client_fx", "dlc5/cosmo/fx_zmb_blackhole_flare_marker");
#precache( "client_fx", "dlc5/cosmo/fx_blackhole_zombie_breakup");

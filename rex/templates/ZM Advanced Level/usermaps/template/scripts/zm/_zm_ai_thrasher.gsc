...
{
	precache();
	level thread thrasher_spawner_init();
...
function thrasher_spawner_init()
{
...
function function_8aac3fe()
{
	...
	level.var_ebc4830 = level.round_number + randomintrange(1, 2);
	while(true)
	{
...
function special_thrasher_spawn()
{
	players = getplayers();

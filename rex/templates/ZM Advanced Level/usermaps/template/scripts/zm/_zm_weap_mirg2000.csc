...
#precache( "client_fx", "dlc2/zmb_weapon/fx_mirg_impact_aoe_chrg2");
#precache( "client_fx", "dlc2/zmb_weapon/fx_mirg_impact_aoe_chrg3");
#precache( "client_fx", "dlc2/zmb_weapon/fx_mirg_impact_aoe_chrg2_ug");
#precache( "client_fx", "dlc2/zmb_weapon/fx_mirg_impact_aoe_chrg3_ug");
#precache( "client_fx", "dlc2/island/fx_spider_death_explo_mirg");
#precache( "client_fx", "dlc2/island/fx_spider_death_explo_mirg_ug");
#precache( "client_fx", "dlc2/zmb_weapon/fx_mirg_impact_explo_default");
#precache( "client_fx", "dlc2/zmb_weapon/fx_mirg_impact_explo_ug");
#precache( "client_fx", "dlc2/zmb_weapon/fx_mirg_weapon_canister_light_green");
#precache( "client_fx", "dlc2/zmb_weapon/fx_mirg_weapon_canister_light_blue");

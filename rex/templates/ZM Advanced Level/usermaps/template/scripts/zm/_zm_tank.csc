...
#precache( "client_fx", "dlc5/tomb/fx_tomb_veh_tank_treadfx_mud" );
#precache( "client_fx", "dlc5/tomb/fx_tomb_mech_wpn_flamethrower" );
#precache( "client_fx", "dlc5/tomb/fx_tomb_veh_tank_exhaust_overheat" );
#precache( "client_fx", "dlc5/tomb/fx_tomb_veh_tank_exhaust" );

require( "ui.uieditor.widgets.HUD.ZM_PowerupsWidget.ZMPowerupsListItem" )
...
DataSources.ZMPowerups = DataSourceHelpers.ListSetup( "ZMPowerups", function ( controller, element )	
	local powerups = {}
...
CoD.ZMPowerupsContainer = InheritFrom( LUI.UIElement )
CoD.ZMPowerupsContainer.new = function ( menu, controller )
	...
	self:setClass( CoD.ZMPowerupsContainer )
	self.id = "ZMPowerupsContainer"
	self.soundSet = "HUD"
	...
	self.PowerupList:setWidgetType( CoD.ZMPowerupsListItem )
	self.PowerupList:setHorizontalCount( 4 )
	self.PowerupList:setDataSource( "ZMPowerups" )
